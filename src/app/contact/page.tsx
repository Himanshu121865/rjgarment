...
const contacts = [
    { icon: Phone, label: 'Phone', value: '+91 98765 43210', href: 'tel:+9198765432100' },
    { icon: MessageCircle, label: 'WhatsApp', value: '+91 98765 43210', href: 'https://wa.me/9198765432100' },
];
                        ...
                        >
                            ...
                            {c.label === 'Phone' && copied && (
                                <div className="flex items-center gap-1 ml-auto border-2 border-black bg-green-100 px-2 py-1">
                                    <Check size={12} />
                                    <span className="font-mono text-[10px] font-bold uppercase">Copied</span>
                                </div>
                            )}
                        </a>
                    ))}
