...
export function TiltCard() {
  ...
  return (
    <motion.div
      ...
      className="relative aspect-square w-full max-w-md rounded-none border-4 border-black bg-white p-3 md:p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[20px_20px_0px_0px_rgba(0,0,0,1)] transition-shadow duration-300 z-10"
    >
      <div
        style={{ transform: "translateZ(60px)" }}
        className="relative h-full w-full border-4 border-black overflow-hidden bg-black"
      >
        <img
