...
export function ColorRevealImg({
  src,
  alt,
  className,
  item,
  ...
  return (
    <div
      ref={ref}
      className={cn("relative overflow-hidden h-full w-full group", className)}
    >
      <img
        src={src}
        alt={alt}
      ...
      {item && (
        ...
        >
          <Heart
            size={16}
            className={saved ? "text-[#ff4800]" : "text-black"}
            fill={saved ? "#ff4800" : "none"}
          />
        </button>
      )}
    </div>
