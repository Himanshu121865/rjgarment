...
export function StoreLocation() {
  ...
  return (
    <section
      id="store-location"
      className="bg-black py-24 md:py-32 px-4 md:px-12 border-b-8 border-white scroll-mt-28"
    >
      <h2 className="text-[#ff4800] text-4xl md:text-8xl font-black uppercase tracking-tighter mb-12 md:mb-16 underline decoration-white decoration-4 md:decoration-8 underline-offset-4 md:underline-offset-8">
        Visit Us
      </h2>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center max-w-7xl mx-auto">
        <div className="space-y-6 md:space-y-8">
          <div className="border-4 md:border-8 border-white bg-black p-6 md:p-8 shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] md:shadow-[16px_16px_0px_0px_rgba(255,255,255,1)]">
            <p className="text-white font-mono text-xs md:text-sm uppercase tracking-widest mb-3 md:mb-4">
              Flagship Store
            </p>
            ...
            <p className="text-gray-400 font-mono text-xs md:text-sm uppercase tracking-wider">
              kh.No.123, Main Market
            </p>
          </div>
          <motion.a
            href="https://maps.app.goo.gl/bBpEPvXQHFkRNpdT7"
            target="_blank"
          ...
          <div className="flex gap-3 md:gap-4">
            <div className="border-4 border-white bg-[#ff4800] p-4 md:p-6 flex-1 shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] md:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
              ...
              <p className="font-mono text-xs md:text-sm font-bold text-black uppercase">
                10:00 – 20:00
              </p>
            </div>
            <div className="border-4 border-white bg-black p-4 md:p-6 flex-1 shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] md:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
              ...
              <p className="font-mono text-xs md:text-sm font-bold text-white uppercase">
                12:00 – 18:00
              </p>
            </div>
          </div>
        ...
        >
          <div className="border-4 border-[#ff4800] m-1.5 md:m-2 overflow-hidden">
            <iframe
              key={mapKey}
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.245203204545!2d77.229327!3d28.612941!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce2daa9eb4d0b%3A0x717c4da1ec3f5d35!2sP6R2%2BP4%2C%20Delhi!5e0!3m2!1sen!2sin!4v1"
              width="100%"
              height="450"
          ...
          <motion.button
            initial={false}
            animate={
              interacted ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.8 }
            }
            onClick={recenter}
